...
if ($_GET['form']=='add') { ?>
	...
	<div id="page-wrapper">
	    <div class="graphs">
	        <h3 class="blank1"><i class="fa fa-edit"></i> Input User</h3>

	        <div class="tab-content bs-example1">
	            <div class="tab-pane active" id="horizontal-form">
	              	<form class="form-horizontal" method="POST" action="modules/user/proses.php?act=insert" enctype="multipart/form-data">
	 
	                	<div class="form-group">
	                  		<label class="col-sm-2 control-label">Username</label>
	                  		<div class="col-sm-5">
	                    		<input type="text" class="form-control1" name="username" autocomplete="off" required>
	                  		</div>
	                	</div>
	                	...
	                	<div class="form-group">
	                  		...
	                  		<div class="col-sm-5">
	                    		<input type="password" class="form-control1" name="password" autocomplete="off" required>
	                  		</div>
	                	</div>
	                	...
	                	<div class="form-group">
	                  		...
	                  		<div class="col-sm-5">
	                    		<input type="text" class="form-control1" name="nama_lengkap" autocomplete="off" required>
	                  		</div>
	                	</div>
	                	...
	                	<div class="form-group">
	              			<div class="col-sm-offset-2 col-sm-10">
	                			...
	                			<a href="?module=user" class="btn btn-warning btn-reset">Batal</a>
	              			</div>
	            		</div>
	              	</form>
	            </div>
...
?>
	...
	<div id="page-wrapper">
	    <div class="graphs">
	        <h3 class="blank1"><i class="fa fa-edit"></i> Ubah Data User</h3>

	        <div class="tab-content bs-example1">
	            <div class="tab-pane active" id="horizontal-form">
	              	<form class="form-horizontal" method="POST" action="modules/user/proses.php?act=update" enctype="multipart/form-data">
